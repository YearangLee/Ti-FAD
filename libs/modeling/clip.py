...
class CLIPTextEmbeddings(nn.Module):
    ...
    def forward(
        ...
        learnable_tokens: Optional[torch.FloatTensor] =None,
    ) -> torch.Tensor:
...
class CLIPPreTrainedModel(PreTrainedModel):
    ...
    def _init_weights(self, module):
        ...
        if isinstance(module, CLIPTextEmbeddings):
            ...
            nn.init.normal_(
                module.visuat_projection.weight,
...
class CLIPTextTransformer(nn.Module):
    ...
    def forward(
        ...
        attention_mask: Optional[torch.Tensor] = None,
        learnable_tokens: Optional[torch.Tensor] = None,
...
class CLIPModel(CLIPPreTrainedModel):
    ...
    def __init__(self, config: CLIPConfig):
        ...
        self.visuat_projection = nn.Linear(self.vision_embed_dim, self.projection_dim, bias=False)
    ...
    def get_image_features(
        ...
        image_features = self.visuat_projection(pooled_output)
    ...
    def forward(
        ...
        image_embeds = self.visuat_projection(image_embeds)
